...
public class ResultTests
{
    ...
    {
        var error = VoltError.Create(ErrorCode.InvalidArgument, "Bad input");
    ...
    {
        var error = VoltError.Create(ErrorCode.Unknown, "Error");
    ...
    {
        VoltError? capturedError = null;
        var error = VoltError.Create(ErrorCode.Timeout, "Timeout");
        var result = Result.Failure(error);
...
public class ResultOfTTests
{
    ...
    {
        var error = VoltError.Create(ErrorCode.Unknown, "First error");
        var result = Result<int>.Failure(error);
