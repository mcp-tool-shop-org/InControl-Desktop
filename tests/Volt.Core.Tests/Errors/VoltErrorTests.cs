...
public class VoltErrorTests
{
    [Fact]
    public void Create_SetsCodeAndMessage()
    {
        var error = VoltError.Create(ErrorCode.InvalidArgument, "Test message");
    ...
    {
        var error = VoltError.Cancelled("Download");
    ...
    {
        var error = VoltError.Timeout("Request", TimeSpan.FromSeconds(30));
    ...
    {
        var error = VoltError.ConnectionFailed("http://localhost:11434", "Ollama");
    ...
    {
        var error = VoltError.ModelNotFound("llama3.2");
    ...
    {
        var error = VoltError.PathNotAllowed("/etc/passwd");
    ...
    public void FromException_MapsTimeoutException()
    {
        ...
        var error = VoltError.FromException(exception);
    ...
    public void FromException_AllowsCodeOverride()
    {
        ...
        var error = VoltError.FromException(exception, ErrorCode.InferenceFailed);
    ...
    public void Timestamp_IsSetAutomatically()
    {
        ...
        var error = VoltError.Create(ErrorCode.Unknown, "Test");
    ...
    public void Error_IsSerializable()
    {
        ...
        var deserialized = System.Text.Json.JsonSerializer.Deserialize<VoltError>(json);
