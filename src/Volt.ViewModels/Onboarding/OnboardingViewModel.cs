...
namespace Volt.ViewModels.Onboarding;
...
public sealed class OnboardingViewModel : INotifyPropertyChanged
{
    ...
    {
        OnboardingStep.Welcome => "Welcome to Volt",
    ...
    public string StepDescription => _currentStep switch
    {
        ...
        OnboardingStep.BackendCheck => "Volt connects to a local inference backend to run models.",
